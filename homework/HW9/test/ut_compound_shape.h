...
TEST(CompoundShape, no_exception_for_constructor_with_empty_shapes)
{
      std::list<Shape*> shapeVec;
      shapeVec.clear();
      Shape* compoundShape = new CompoundShape("7", shapeVec);
...
TEST(CompoundShape, no_exception_for_constructor_with_empty_shapes1)
{
      std::list<Shape*> shapeVec;
      shapeVec.clear();
      Shape* compoundShape = new CompoundShape("7", shapeVec);
      Shape* compoundShape1 = new CompoundShape("4", shapeVec);
      compoundShape1->addShape(compoundShape);
      ASSERT_EQ("Compound Shape {Compound Shape {}}", compoundShape1->info());
}
